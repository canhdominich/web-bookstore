			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div style="margin-bottom: 30px; text-align: end;">
						<a href="/admin/new/book" class="btn btn-info btn-add text-white">Thêm sách</a>
					</div>
				<div class="row">
						...
						<tbody>
							...
							<tr>
								...
								<td class="col-sm-2 text-center">
									<img style="width: 100px; height: 200px; border-radius: 0;" src="{{url('images/books/'.$value->image)}}" alt=" text-center">
								</td>
								<td class="col-sm-1 text-center">{{$value->author}}</td>
								<td class="col-sm-1 text-center">{{$value->price}}</td>
								<td class="col-sm-1 text-center">{{$value->price_sale}}</td>
	...
	$('.btn-show').click(function(){
		...
		$.ajax({
			...
			success : function(response){
				...
				$('#showImage').attr('src', '/images/categories/'+response.image),
	...
	$('.btn-edit').click(function(){
		...
		$.ajax({
			...
			success : function(response){
				...
				$('#image').attr('src', '/images/categories/'+response.image),
