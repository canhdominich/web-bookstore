        ...
        <table id="list-orders" class="table table-bordered table-striped" style="margin-top : 10px;">
          <thead>
            <tr>
              ...
              <th class="col-sm-2" style="text-align : center;">Trạng thái hiện tại</th>
              <th class="col-sm-2" style="text-align : center;">Tiến hành giao hàng</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="col-sm-2" style="text-align : center;">
                <button data-id="{{$value->user_id}}" type="button" class="btn btn-warning btn-show">
                  {{$value->phone}}
                </button>
              </td>
...
<script>
  $(document).ready(function() {
    $('#list-orders').DataTable( {
      "lengthMenu": [[35, 100, 200, 500, -1], [35, 100, 200, 500, "All"]],
      "order": [[2, 'desc']]
    } );
  } );
</script>
