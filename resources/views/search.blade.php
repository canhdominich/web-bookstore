                                ...
                                <div class="product-item" style="height : 380px; margin-top : 30px; box-sizing : border-box;">
                                    <div class="product-shop-top">
                                        <a href="{{ url('/san-pham/'.$item->slug) }}" title="" class="product-image">
                                            ...
                                            <img class="em-alt-hover img-responsive em-lazy-loaded" src="{{url('images/books/'.$item->image)}}" alt="{{$item->name}}" style="width: 100%;">

                                            <img class="img-responsive em-alt-org em-lazy-loaded" src="{{url('images/books/'.$item->image)}}" alt="{{$item->name}}" style="width: 100%;">
                                        </a>
