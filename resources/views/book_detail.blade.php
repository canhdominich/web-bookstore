@extends('layouts.home') @section('title') @if(isset($book))
{{$book->name}}
@else Chi tiết sách - Book Store @endif @endsection @section('js')
<script
    type="text/javascript"
    src="{{ asset('home/js/sweetalert.min.js') }}"
></script>
@endsection @section('home') @if(isset($book)) @csrf
                                                ...
                                                <div class="">
                                                    ...
                                                    >
                                                        <a
                                                            ...
                                                            href="{{asset('images/books/'.$book->image)}}"
                                                        >
                                                            <img
                                                    ...
                                                    >
                                                        ...
                                                        <p class="old-price">
                                                            <span
                                                                ...
                                                                "
                                                            >
                                                                {{number_format($book->price*1000 ,0 ,'.' ,'.')}}
                                                                VND
                                                            </span>
                                                        </p>
                                                        @endif
