    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="products_menu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/new/book') }}">Thêm sản phẩm</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/book') }}">Danh sách sản phẩm</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
