                ...
                <div class="row">
                    <div class="col-sm-18 col-sm-push-6 em-col-main">
                        ...
                        <div class="category-products">
                                                ...
                                                <div class="product-item" style="height : 380px; margin-top : 30px; box-sizing : border-box;">
                                                    <div class="product-shop-top">
                                                        <a href="{{ url('/san-pham/'.$item->slug) }}" title="" class="product-image">
                                                            ...
                                                            <img class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('images/books/'.$item->image)}}" alt="{{$item->name}}" style="width: 100%;">

                                                            <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('images/books/'.$item->image)}}" alt="{{$item->name}}" style="width: 100%;">
                                                        </a>
                            ...
                            <div style="text-align: center;">
                                {!! urldecode($books->appends(request()->query())->links('vendor.pagination.default')); !!}
                            </div>
                    ...
                    <div class="col-sm-6 col-sm-pull-18 em-col-left em-sidebar">
                        ...
                        <div class="em-line-01 block block-layered-nav">
                            ...
                            @if(isset($price_sale_min_book) && isset($price_sale_max_book))
                            <div class="em-block-title" style="text-align : center;"> 
                                <strong><span style="color : #fff;">Giá bán (VND)</span></strong>
                            </div>

                            <div class="block-content" style="text-align : center;" >
                                <input id="price-slider-amount" type="text" value="" class="slider form-control" data-slider-min="{{ $price_sale_min_book*1000 }}" data-slider-max="{{ $price_sale_max_book*1000 }}"
                                data-slider-step="1" 
                                ...
                                <div class="" style="font-size : 12px;"> 
                                    Giá từ: 
                                    <span class="from">{{number_format($price_sale_min_book*1000 ,0 ,'.' ,'.')}} VND</span>
                                    — 
                                    <span class="to">{{number_format($price_sale_max_book*1000 ,0 ,'.' ,'.')}} VND</span>
                                    </div>
