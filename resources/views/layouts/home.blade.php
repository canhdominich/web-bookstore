...
<head>
    ...
    <meta name="description" content="Đến với mọi cửa hàng của Book Store, bạn đều được trải nghiệm và mua sắm những sản phẩm chất lượng cao, uy tín hàng đầu trên thị trường chăm sóc sức khỏe">
                            ...
                            <div class="row">
                                <div class="col-sm-24">
                                    <div class="em-footer-address"> 
                                        <address class="f-left">&copy; Bản quyền thuộc về Book Store</address>
                                    </div>
                                </div>
                            </div>
                        </div>
