...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('assets/template/css/style.css') }}"
        />
        <!-- endinject -->
        <link
            rel="shortcut icon"
            href="{{ asset('assets/template/images/favicon.png') }}"
        />
        <script
            type="text/javascript"
            src="{{ asset('assets/js/sweetalert.min.js') }}"
        ></script>
    </head>
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <i
                                    class="mdi mdi-file-document-box-outline menu-icon"
                                ></i>
