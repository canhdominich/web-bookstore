            ...
            <div class="em-slideshow">
                <div class="em-owlcarousel-slideshow">
                    <div id="em_owlcarousel_2_2484_sync1" class="owl-carousel">
                        <div class="item">
                            <a href=""> 
                                <img alt="" class="lazyOwl img-responsive" src="https://theme.hstatic.net/1000363117/1000911694/14/ms_banner_img4.jpg?v=287" /> 
                            </a>
                        </div>
                                                                                ...
                                                                                <div class="product-item" style="height : 400px; margin-top : 30px; box-sizing : border-box;">
                                                                                    <div class="product-shop-top">
                                                                                        <a href="{{ url('/san-pham/'.$item->slug) }}" title="" class="product-image">
                                                                                            ...
                                                                                            <img class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('images/books/'.$item->image)}}" alt="{{$item->name}}" style="width: 100%; height: 220px;">

                                                                                            <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('images/books/'.$item->image)}}" alt="{{$item->name}}" style="width: 100%; height: 220px;">
                                                                                        </a>
                                                ...
                                                <div class="widget em-filterproducts-grid">
                                                    <div class="widget-products em-widget-products">
                                                        ...
                                                        <div class="products-grid ">
                                                            ...
                                                            @if(isset($new_healthfoods))
                                                                @foreach($new_healthfoods as $item)
                                                                    <div class="item last" style="  ">
                                                                ...
                                                                <div class="" style="margin-right: 10px;">
                                                                    <a href="{{url('/cua-hang/thuc-pham-chuc-nang')}}">
                                                    ...
                                                    <div class="widget-products em-widget-products">
                                                        <div class="emcatalog-desktop-6">
                                                            <div class="products-grid ">
                                                                ...
                                                                @if(isset($new_consumergoods))
                                                                    @foreach($new_consumergoods as $item)
                                                                        <div class="item last" style="  ">
                                                ...
                                                <div class="widget em-filterproducts-grid">
                                                    <div class="widget-products em-widget-products">
                                                        ...
                                                        <div class="products-grid ">
                                                            ...
                                                            @if(isset($new_medicalequipments))
                                                                @foreach($new_medicalequipments as $item)
                                                                    <div class="item last" style="  ">
        ...
        <div class="col-sm-6 text-center em-wrapper-ads-item  line-left line-right">
            <div class="em-ads-item">
                ...
                <div class="em-ads-content">
                    ...
                    <p>Dễ dàng đặt hàng online nhanh chóng trên Book Store thông qua mọi thiết bị</p>
                </div>
            </div>
        </div><!-- /.em-wrapper-ads-item -->
        <div class="col-sm-6 text-center  em-wrapper-ads-item  line-left line-right">
